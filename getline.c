 ...
 * @buf: address of buffer in a function
 * @len: address of len var in a function
 *
 * Return: bytes read
 */
 ...
 * @length: size of length ptr buffer if not NULL
 * Return: s
 */
...
/**
 * sigintHandler - the function that blocks ctrl-C
 * @sig_num: signal number of a parameter
 * Return: 0
 */

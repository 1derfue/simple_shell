...
/**
 * print_list_str - a function that prints only the str element of a list
 * @h: pointer to first node of a function
 *
 * Return: size of list
 */
 ...
 * @index: index of node to delete in the function
 *
 * Return: 1 or 0
 */
 ...
 * @head_ptr: a pointer to head node
 *
 * Return: 0
 */
